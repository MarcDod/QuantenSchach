        ...
        public boolean validateMove(Point stand, Point target, boolean down,
            ...
            switch(this){
                case DAME:
                    ...
                    for(int i = 0; i < ((absX > absY) ? absX : absY); i++){
                        if(field[stand.y + i * (dY / absY)][stand.x + i
                                * (dX / absX)] != null){
                            return false;
                        }
                    }
                ...
                case BAUER:
                    ...
                    if(absY == 1 && field[target.y][target.x].getColor()
                            == color){
                        return false;
                    }
                    if((down ? 1 : -1) != dX){
            ...
            Figur targetFigur = field[target.y][target.x];
